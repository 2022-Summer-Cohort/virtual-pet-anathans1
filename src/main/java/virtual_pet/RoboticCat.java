...
public class RoboticCat extends RoboticVirtualPet {
    public RoboticCat(String name, int needForOilChange, int needForMaintenance) {
...
//        System.out.println("and its need for maintenance is at a " + getNeedForMaintenance() + "/10.");
