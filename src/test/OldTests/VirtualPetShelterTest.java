...
//import virtual_pet.FinalVirtualPet;
...
//        VirtualPet TestPet = new VirtualPet("testName",2,2,2);
...
//        assertTrue(underTest.getShelter().add(new VirtualPet("testName",2,2,2)));
...
//        VirtualPetShelter underTest = new VirtualPetShelter();
//        underTest.admitToVirtualPetShelter(new VirtualPet("Rockie",5,5,5));
