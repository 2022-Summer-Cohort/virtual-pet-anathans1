...
public class VirtualPetTest {
    ...
    void greetingShouldReturnStatus() {
        VirtualPet underTest = new VirtualPet("test", 2, 3, 4, 5);
        String expectedOutput = "\uD83E\uDD9Dtest's\uD83E\uDD9D hunger level is 2, his thirst level is 4, his boredom level is 5 and his urge to steal is 3";
...
//
    ...
    void thirstLevelShouldGoTo0WhenWater() {
        VirtualPet underTest = new VirtualPet("test", 3, 4, 5, 6);
        underTest.water();
        underTest.tick();
